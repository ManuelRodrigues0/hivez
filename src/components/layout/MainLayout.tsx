...
export default function MainLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-white dark:bg-black text-zinc-900 dark:text-white">
      ...
      <header className="hidden lg:flex lg:fixed lg:top-0 lg:left-0 lg:right-0 lg:z-50 lg:h-16 lg:items-center lg:justify-between lg:border-b lg:border-zinc-200 dark:lg:border-zinc-800 lg:bg-white dark:lg:bg-black lg:px-4">
        {/* Left side - Menu + Logo */}
